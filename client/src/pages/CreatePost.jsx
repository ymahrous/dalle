  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-6">
          <p className="mt-2 text-[#666e75] text-[14px]">once you've created the image, you can share it with others everywhere</p>
          <button className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center" type="submit">{loading ? 'sharing...' : 'Share'}</button>
        </div>
      </form>
    </section>
  );
